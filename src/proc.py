...
class DataWorkflows:
    ...
    @staticmethod
    def process_upload_column(codes_path, gdb_folder, cred=None, count=None, backup_uploaded=None):
    ...
    @staticmethod
    def process_sanitize_column(gdb_folder, count=None, buffer_erase_cm=None, skip_overlap_fix=None):
        ...
        try:
            ...
            for i, survey_unit in enumerate(sanitize_list, 1):
                ...
                try:
                    ...
                    success, message, feature_count = sanitizer.sanitize_feature_class(fc_path, buffer_erase_cm=buffer_erase_cm, skip_overlap_fix=skip_overlap_fix)
